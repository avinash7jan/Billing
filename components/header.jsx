					...
					<div className="com_cont notification_box arrow_box"  ref={node => { this.node = node; }}>
						...
						<ul className="notification_contents">
							...
							<li  className="com_notification_hover">
								...
								<div>2 mor</div>
								<div className="green_text"><a onClick={this.dotRemove1} href="aaa#" target="_blank">Manage renewal</a></div>
							</li>
							...
							<li className="com_notification_hover">
								...
								<div className="green_text"><a onClick={this.dotRemove2} href="aaa#" target="_blank">Manage renewal</a></div>
							</li>
							...
							<li  className="com_notification_hover"  >
								...
								<div>Product Design Collection</div>
								<div>2 mor</div>
								<div className="green_text"><a onClick={this.dotRemove3} href="aaa#" target="_blank">Manage renewal</a></div>
							</li>
